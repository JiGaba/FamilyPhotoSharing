...
{
    public class SharedPhotoAlbumSelectByHostUserId : SharedPhotoAlbumBase
    {
        ...
        public virtual SharedPhotoAlbumsModel ToSharedPhotoAlbumsModel() => new SharedPhotoAlbumsModel
        {
